    ...
    try {
      ...
      records.forEach((record) => {
        ...
        row.innerHTML = `
              ...
              <td>
                  <select onchange="updateFinalDecision('${record.id
          }', this.value)">
                      <option value="Pending" ${record.finalDecision === "Pending" ? "selected" : ""
          }>Pending</option>
                      <option value="Selected" ${record.finalDecision === "Selected" ? "selected" : ""
          }>Selected</option>
                      <option value="Not Selected" ${record.finalDecision === "Not Selected"
            ? "selected"
            : ""
          }>Not Selected</option>
                  </select>
